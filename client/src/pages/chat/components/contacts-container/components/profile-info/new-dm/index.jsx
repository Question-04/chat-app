...
import { animationDefaultOptions, getcolour } from "@/lib/utils";
        ...
        <DialogContent className="bg-[#181928] border-none text-white w-[400px] h-[400px] flex flex-col">
          ...
          <div>
            <Input
              ...
              className="rouded-lg p-6 bg-[#2c2e3b] "
                  ...
                  <div className="w-12 h-12 relative">
                    <Avatar className="h-12 w-12 rounded-full overflow-hidden">
                      {contact.image ? (
                        ...
                        <div
                          className={`uppercase h-12 w-12  text-lg border-[1px] flex items-center justify-center rounded-full ${getcolour(
                            contact.colour
                          )}`}
                        >
                          {contact.firstName
