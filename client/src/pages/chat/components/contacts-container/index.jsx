...
const {setDirectMessagesContacts, directMessagesContacts} = useAppStore();
  ...
  useEffect(() =>{
    ...
    return (
      <div className="flex flex-col relative md:w-[35vw] lg:w-[30vw] xl:w-[20vw] bg-[#1b1c24] border-r-2 border-[#2f303b] w-full">
        <div className="pt-3">
          <Logo />
        </div>
        <div className="my-2 flex items-center justify-between pr-6"> {/* Reduced margin */}
...
const Logo = () => {
    return (
      <div className="flex p-5 justify-start items-center gap-2">
        ...
        <span className="text-3xl font-semibold">Comozzy</span>
      </div>
    );
};
