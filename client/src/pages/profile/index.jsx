...
import { colours, getcolour } from "@/lib/utils";
...
const Profile = () => {
  ...
  useEffect(() => {
    if (userInfo.profileSetup) {
      ...
      setselectedColour(userInfo.colour);
    }
    if(userInfo.image){
    ...
    if (validateProfile()) {
      try {
        const response = await apiClient.post(
          ...
          { firstName, lastName, colour: selectedColour },
            ...
            <Avatar className="h-32 w-32 md:w-48 md:h-48 rounded-full overflow-hidden">
              {image ? (
                ...
                <div
                  ...
                  style={{
                    backgroundColor: colours[selectedColour], // Set background color based on selected colour
                  }}
                >
                  {firstName
